<?php 
$pageTitle = "Personal Loan Calculator | MultiTool";
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8">
            <h1><i class="fas fa-hand-holding-usd text-primary"></i> Personal Loan Calculator</h1>
            <p class="lead">Calculate your personal loan EMI and interest payments.</p>
                ...
                <div class="card-body">
                    <form id="personalLoanForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="interestRate" placeholder="e.g. 12.5" required>
                        </div>
                        <div class="mb-3">
                            <label for="loanTenure" class="form-label">Loan Tenure (months)</label>
                            <input type="number" class="form-control" id="loanTenure" placeholder="e.g. 36" required>
                        </div>
...
<script>
document.getElementById('personalLoanForm').addEventListener('submit', function(e) {
    e.preventDefault();
